...
public class CRUle {
	 ...
	 */
	public CRUle(BasicSet ant, BasicSet cons, double supp, double conf, double li,String mod,String att) {
		antecedent = ant;
		consequence = cons;
		support = supp;
		confidence = conf;
	 ...
	 * @param cons la consequence de la regle
	 */
	public CRUle(BasicSet ant, BasicSet cons) {
		antecedent = ant;
		consequence = cons;
		support = 1.0;
		confidence = 1.0;
